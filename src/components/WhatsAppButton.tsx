...
const WhatsAppButton = ({ href = WHATSAPP_URL, positionClassName = "bottom-6 right-6" }: WhatsAppButtonProps) => {
  return (
    <a
      href={href}
      target="_blank"
      ...
      className={`fixed ${positionClassName} z-50 flex items-center gap-2 bg-[#25D366] hover:bg-[#2be472] text-white rounded-full px-5 py-3 shadow-lg hover:shadow-xl transition-all hover:scale-105 active:scale-95 max-[480px]:px-3 max-[480px]:py-3`}
    >
